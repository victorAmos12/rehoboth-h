...
export class MedicalFileService {
   ...
   */
  getPatientMedicalFiles(patientId: number, page: number = 1, limit: number = 20): Observable<MedicalFilesResponse> {
    const params = new HttpParams().set('page', page.toString()).set('limit', limit.toString());

    return this.http.get<MedicalFilesResponse>(`${this.apiUrl}/patient/${patientId}`, {
      headers: this.getHeaders(),
      params,
    });
  }
  ...
  getActiveMedicalFile(patientId: number): Observable<MedicalFileResponse> {
    return this.http.get<MedicalFileResponse>(`${this.apiUrl}/patient/${patientId}/actif`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  getHopitalMedicalFiles(hopitalId: number, page: number = 1, limit: number = 20): Observable<MedicalFilesResponse> {
    const params = new HttpParams().set('page', page.toString()).set('limit', limit.toString());

    return this.http.get<MedicalFilesResponse>(`${this.apiUrl}/hopital/${hopitalId}`, {
      headers: this.getHeaders(),
      params,
    });
  }
  ...
  getMedicalFile(id: number): Observable<MedicalFileResponse> {
    return this.http.get<MedicalFileResponse>(`${this.apiUrl}/${id}`, {
      headers: this.getHeaders(),
    });
  }
  ...
  createMedicalFile(data: Partial<MedicalFile>): Observable<MedicalFileResponse> {
    return this.http.post<MedicalFileResponse>(this.apiUrl, data, {
  ...
  updateMedicalFile(id: number, data: Partial<MedicalFile>): Observable<MedicalFileResponse> {
    return this.http.put<MedicalFileResponse>(`${this.apiUrl}/${id}`, data, {
      headers: this.getHeaders().set('Content-Type', 'application/json'),
    });
  }
  ...
  deleteMedicalFile(id: number): Observable<MedicalFileResponse> {
    return this.http.delete<MedicalFileResponse>(`${this.apiUrl}/${id}`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  addFamilyHistory(dossierMedicalId: number, data: Partial<FamilyHistory>): Observable<FamilyHistoryResponse> {
    return this.http.post<FamilyHistoryResponse>(`${this.apiUrl}/${dossierMedicalId}/antecedents-familiaux`, data, {
      headers: this.getHeaders().set('Content-Type', 'application/json'),
    });
  }
  ...
  getFamilyHistory(dossierMedicalId: number): Observable<FamilyHistoryResponse> {
    return this.http.get<FamilyHistoryResponse>(`${this.apiUrl}/${dossierMedicalId}/antecedents-familiaux`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  deleteFamilyHistory(dossierMedicalId: number, familyHistoryId: number): Observable<FamilyHistoryResponse> {
   ...
   */
  addVaccination(dossierMedicalId: number, data: Partial<Vaccination>): Observable<VaccinationResponse> {
    return this.http.post<VaccinationResponse>(`${this.apiUrl}/${dossierMedicalId}/vaccinations`, data, {
      headers: this.getHeaders().set('Content-Type', 'application/json'),
    });
  }
  ...
  getVaccinations(dossierMedicalId: number): Observable<VaccinationResponse> {
    return this.http.get<VaccinationResponse>(`${this.apiUrl}/${dossierMedicalId}/vaccinations`, {
      headers: this.getHeaders(),
    });
  }
  ...
  updateVaccination(
    ...
    return this.http.put<VaccinationResponse>(`${this.apiUrl}/${dossierMedicalId}/vaccinations/${vaccinationId}`, data, {
      headers: this.getHeaders().set('Content-Type', 'application/json'),
    });
  }
   ...
   */
  deleteVaccination(dossierMedicalId: number, vaccinationId: number): Observable<VaccinationResponse> {
    return this.http.delete<VaccinationResponse>(`${this.apiUrl}/${dossierMedicalId}/vaccinations/${vaccinationId}`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  addCriticalInfo(dossierMedicalId: number, data: Partial<CriticalInfo>): Observable<CriticalInfoResponse> {
    return this.http.post<CriticalInfoResponse>(`${this.apiUrl}/${dossierMedicalId}/informations-critiques`, data, {
      headers: this.getHeaders().set('Content-Type', 'application/json'),
    });
  }
  ...
  getCriticalInfo(dossierMedicalId: number): Observable<CriticalInfoResponse> {
    return this.http.get<CriticalInfoResponse>(`${this.apiUrl}/${dossierMedicalId}/informations-critiques`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  deleteCriticalInfo(dossierMedicalId: number, criticalInfoId: number): Observable<CriticalInfoResponse> {
  ...
  getSupplementaryInfo(dossierMedicalId: number): Observable<SupplementaryInfoResponse> {
    return this.http.get<SupplementaryInfoResponse>(`${this.apiUrl}/${dossierMedicalId}/informations-supplementaires`, {
      headers: this.getHeaders(),
    });
  }
   ...
   */
  deleteSupplementaryInfo(dossierMedicalId: number, supplementaryInfoId: number): Observable<SupplementaryInfoResponse> {
   ...
   */
  exportMedicalFilePDF(dossierMedicalId: number): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/${dossierMedicalId}/export/pdf`, {
      headers: this.getHeaders(),
      responseType: 'blob',
    });
  }
